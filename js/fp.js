...
function editct3(id){
  abc.style.display = "block";
  document.getElementsByName("submit")[0].value=id;
  var namect =document.getElementById(id).parentElement.parentElement.getElementsByTagName("td")[0].innerText;
  document.getElementById('ctname').value=namect;
  var quoctich =document.getElementById(id).parentElement.parentElement.getElementsByTagName("td")[2].innerText;
  document.getElementById('nationality').value=quoctich;
  var ngaysinh =document.getElementById(id).parentElement.parentElement.getElementsByTagName("td")[3].innerText;
  document.getElementById('birthday').value=ngaysinh;
  var vitri =document.getElementById(id).parentElement.parentElement.getElementsByTagName("td")[1].innerText;
  document.getElementById('vitri').value=vitri;
  var doi =document.getElementById(id).parentElement.parentElement.getElementsByTagName("td")[5].innerText;
  document.getElementById('idteam').value=doi;
}
...
function editct4(id){
  ...
  document.getElementsByName("submit")[0].value=id;
  var namect =document.getElementById(id).parentElement.parentElement.getElementsByTagName("td")[0].innerText;
  document.getElementById('ctname2').value=namect;
  var quoctich =document.getElementById(id).parentElement.parentElement.getElementsByTagName("td")[2].innerText;
  document.getElementById('nationality2').value=quoctich;
  var ngaysinh =document.getElementById(id).parentElement.parentElement.getElementsByTagName("td")[3].innerText;
  document.getElementById('birthday2').value=ngaysinh;
  var vitri =document.getElementById(id).parentElement.parentElement.getElementsByTagName("td")[1].innerText;
  document.getElementById('vitri2').value=vitri;
  var doi =document.getElementById(id).parentElement.parentElement.getElementsByTagName("td")[5].innerText;
  document.getElementById('idteam2').value=doi;
}
//chinh sua ti so
