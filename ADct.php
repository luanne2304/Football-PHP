                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) { ?>
                                    <tr id="tr<?php echo $row['idct'] ?>" >
                                        ...
                                        <td style="display: none;"><?php echo $row['idteam'] ?></td>
                                        <td><i onclick="editct3(this.id)" id="ct<?php echo $row['idct'] ?>" class="fa-solid fa-pen-to-square"></i></td>
                                    </tr>
                            <?php
                                }
